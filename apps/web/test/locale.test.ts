...
import { languageCookieOptions } from '../lib/invitation-access';
...
describe('locale preference', () => {
  ...
  it('keeps a safe year-long application-wide manual preference', () => {
    expect(languageCookieOptions).toMatchObject({
      httpOnly: false,
      sameSite: 'lax',
      path: '/',
      maxAge: 365 * 24 * 60 * 60,
